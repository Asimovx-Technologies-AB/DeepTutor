          ...
          >
            ...
            <div className="mb-5 p-3 rounded-[1.5rem] bg-info-soft border border-info/30 flex items-center gap-2.5">
              ...
              <p className="text-xs text-text-primary font-medium">
                <span className="font-bold text-info">Demo Mode:</span> Fill in any details to create your profile.
              </p>
            </div>
            ...
            <p className="text-center text-xs font-semibold text-text-secondary mt-5">
              ...
              <Link to="/login" className="text-info hover:text-[#1899D6] font-black transition-colors">
                Login
              </Link>
            </p>
