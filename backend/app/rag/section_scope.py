...
def get_section_collection_id(user_id: str, section_id: str) -> str:
    """
    Deterministic collection name for a user-owned uploaded section.
    """
...
async def get_section_context(
    ...
    """
    Fetch text chunks scoped to this user's uploaded section.
    """
    ...
    # User-uploaded documents / personal chat sections only.
